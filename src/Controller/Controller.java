...
//private Authentification auth_interf;
	...
	public boolean pseudoValidity(String pseudo) throws IOException {
		...
		//on n'a pas besoin d'envoyer le port udp listening car tous les utilisateurs ont le m�me
	...
	public void changePseudo(String newPseudo) {
		...
		else System.out.println("Veuillez saisir un pseudo diff�rent que celui que vous avez");
	}
	...
	//broadcast est une fonction qui envoie � tous les utilisateur "message" en utilisant UDPport de l'utilisateur
	public void broadcast(DatagramSocket dgramSocket,String message) throws IOException {
		byte buffer[] = null;
		buffer = message.getBytes();
		InetAddress broadcast_IP = InetAddress.getByName("10.1.255.255"); //mettre l'adresse broad du r�seau
